...
function calcPincipal () {
    ...
    var total1 = parseFloat(comprimento1) / parseFloat(peso1);
    ...
    document.getElementById('res1').innerHTML = total1.toFixed(1)+" Kg";
}
...
function calcDerivacao () {
    ...
    var total2 = parseFloat(comprimento2) / parseFloat(peso2);
    ...
    document.getElementById('res2').innerHTML = total2.toFixed(1)+" Kg";
}
...
function calcPesoTot() {
    ...
    var calculo1 = parseFloat(comprimento1) / parseFloat(peso1);
    var calculo2 = parseFloat(comprimento2) / parseFloat(peso2);
